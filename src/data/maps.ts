...
// % pozycja środka hotspotu (postać + numerek) na public/images/mirage/t-spawn-select.webp
const SPAWN_COORDS: Record<number, { xPct: number; yPct: number }> = {
  1: { xPct: 80.5, yPct: 80 },
  2: { xPct: 15, yPct: 80 },
  3: { xPct: 72.25, yPct: 50 },
  4: { xPct: 54.5, yPct: 52 },
  5: { xPct: 39, yPct: 52 },
  6: { xPct: 23.5, yPct: 50 },
  7: { xPct: 79.25, yPct: 33 },
  8: { xPct: 63.75, yPct: 33 },
  9: { xPct: 48.25, yPct: 33 },
  10: { xPct: 32.75, yPct: 33 },
}
